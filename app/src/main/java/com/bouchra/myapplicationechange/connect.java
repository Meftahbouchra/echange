            ...
            public void onClick(View v) {
                ...
                if (!eemail.isEmpty() && !ppassword.isEmpty()) {
                    if (ppassword.length() >= 6) {
                        ...
                        Toast.makeText(connect.this, "Le mot de passe doit comporter au mois 6 caractéres ", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(connect.this, "Vous devez remplir les champs", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        mAut.signInWithEmailAndPassword(eemail, ppassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(connect.this, " impossible de se connecter ,vèrifier vos donnèes", Toast.LENGTH_SHORT).show();
                }
